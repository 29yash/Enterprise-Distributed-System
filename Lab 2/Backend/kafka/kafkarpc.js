...
KafkaRPC.prototype.makeRequest = function(topic_name, response_topic_name, content, callback){
    ...
    self.setupResponseQueue(self.producer,topic_name, response_topic_name, function(){
...
KafkaRPC.prototype.setupResponseQueue = function(producer,topic_name, response_topic_name, next){
