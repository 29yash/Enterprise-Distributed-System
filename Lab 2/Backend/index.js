...
App.use(cors({ origin: 'http://cmpe273homeaway.s3-website-us-west-2.amazonaws.com', credentials: true }));
...
App.use(function(req, res, next) {
  res.setHeader('Access-Control-Allow-Origin', 'http://cmpe273homeaway.s3-website-us-west-2.amazonaws.com');
